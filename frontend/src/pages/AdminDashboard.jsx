...
// ── ManualSection removed — merged into VehiclesSection ──────
const NAV_ITEMS = [
  { id: 'dashboard', icon: '📊', label: 'Dashboard',       group: 'Overview'   },
  { id: 'vehicles',  icon: '🚗', label: 'Vehicles',        group: 'Overview'   },
...
export default function AdminDashboard() {
  ...
  function renderSection() {
    switch (section) {
      ...
      case 'vehicles':  return <VehiclesSection  showToast={showToast} />
    ...
    <>
      ...
      `}>
        <div className="flex items-center justify-between px-2 py-3 mb-2">
          <Brand />
          <button onClick={() => setSidebarOpen(false)} className="text-[#8DA4BF] hover:text-white text-xl ml-2">
            ✕
          </button>
        </div>
        <SidebarNav />
